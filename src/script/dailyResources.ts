...
import { type Resource as ResourceType } from '../types/resource.type.ts';
import { renderResources } from './resourceRendering.ts';
import { setupModalEvents } from './modalRendering.ts';
